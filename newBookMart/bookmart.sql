...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 15, 2018 at 04:37 AM
...
INSERT INTO `booktocart` (`booktocart_id`, `fk_customer_id`, `fk_sells_id`) VALUES
(1, 1, 1),
(2, 1, 2);
...
(1, 1, 340, '2018-04-14', 0, NULL),
(2, 2, 320, '2018-04-14', 0, NULL);
...
INSERT INTO `sells` (`sells_id`, `fk_seller_id`, `fk_book_id`, `sells_price`, `availability`) VALUES
(1, 1, 15, 450, 3),
(2, 4, 13, 340, 2);
...
--
ALTER TABLE `booktocart`
  MODIFY `booktocart_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `sells`
  MODIFY `sells_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
